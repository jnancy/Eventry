    ...
    return (
      ...
      <Row style={{ marginLeft: 10, marginRight: 10}}>
        <View style={{flex: 1, flexDirection: 'row'}}>
          <Image
            style={{height: height* 0.12, width: height* 0.12, borderRadius: 50}}
            source={{ uri: default_avatars[Math.floor(Math.random()*6)]  }}
          />
          ...
          <IonIcon type="Ionicons" name="md-checkmark-circle-outline" color="green"  size={25}/>
          <Text style={{fontSize:8, color: 'green'}}>Attending</Text>
  ...
  render() {
    ...
    if(this.state.isLoading){
      ...
      <View style={styles.container}>
          ...
          <Body>
          <Title>EVENTRY</Title>
          <Subtitle>Event Attendees</Subtitle>
          </Body>
          <Right></Right>
          </Header>
          <ImageBackground
            style={{height: height* 0.2, width: width}}
            source={{ uri: 'https://i.imgur.com/oShEWFF.jpg'}}
          >
            <Tile>
              ...
              <Button styleName="secondary"
                      onPress={() => goBack()}>
                <Icon name="add-event" />
                <SText>BACK TO EVENTS LIST</SText>
              </Button>
              </Overlay>
            </Tile>
          </ImageBackground>
